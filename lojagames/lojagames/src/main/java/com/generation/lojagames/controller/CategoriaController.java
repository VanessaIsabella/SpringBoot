...
public class CategoriaController {
		...
		public ResponseEntity<List<Categoria>> getByFaixaEtaria(@PathVariable Long faixaEtaria){
			return ResponseEntity.ok(categoriaRepository.findAllByFaixaEtaria(faixaEtaria));
		}
